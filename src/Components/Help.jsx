...
// import React from 'react';
// import Help from './Help'; // Assuming Help component is in a separate file
...
//       </div>
//       <div style={{ flex: '1', backgroundColor: '#1F1F1F', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
//         <div style={{ backgroundColor: "#171717", height: "600px", width: "600px" }}>
//                 <h1 style={{color: "#3A55EB"}}>This is the help page</h1>
//         </div>
//       </div>
//     </div>
//   );
